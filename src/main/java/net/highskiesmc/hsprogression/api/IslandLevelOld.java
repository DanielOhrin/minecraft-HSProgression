...
public enum IslandLevelOld {
    ...
    // Constructor
    IslandLevelOld(int maxSpawners, int islandRadius, int maxMembers, long cost) {
    ...
    public ItemStack getItem(int islandLevel) {
        ...
        if (itemLevel != 1) {
            int memberDifference = MAX_MEMBERS - IslandLevelOld.values()[ordinal() - 1].MAX_MEMBERS;
