...
public class IslandFarmingCommand implements SuperiorCommand {
    private final HSPlugin main;
    private final Config config;

    public IslandFarmingCommand(HSPlugin main) {
        super();
        this.main = main;
    ...
    public String getPermission() {
        return "hsprogression.cmd.farming";
    }
    ...
    public String getDescription(Locale locale) {
        return "Opens the farming menu for your island";
    }
    ...
    public void execute(SuperiorSkyblock superiorSkyblock, CommandSender commandSender, String[] strings) {
        ...
        player.openInventory(new IslandProgressionGUI((HSProgression) main, player, island,
                IslandProgressionType.FARMING).getInventory());
    }
